...
The *Sequence Diagram* below shows how the components interact with each other for the scenario where the user issues the command `delete_tutorial t/T1`.
...
![Interactions Inside the Logic Component for the `delete 1` Command](images/UpdatedDeleteSequenceDiagram.png)
