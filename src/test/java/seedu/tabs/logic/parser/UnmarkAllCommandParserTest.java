...
public class UnmarkAllCommandParserTest {

    private final UnmarkAllCommandParser parser = new UnmarkAllCommandParser();

    @Test
    public void parse_validArgs_returnsMarkAllCommand() {
        assertParseSuccess(parser, CommandTestUtil.TUTORIAL_DESC_C123,
                new UnmarkAllCommand(TypicalPredicates.PREDICATE_KEYWORD_C123));
    }
