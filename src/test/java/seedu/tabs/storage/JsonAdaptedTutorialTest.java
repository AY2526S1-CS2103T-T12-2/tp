...
public class JsonAdaptedTutorialTest {
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedTutorial tutorial =
                new JsonAdaptedTutorial(VALID_TUTORIAL_ID, VALID_MODULE_CODE, VALID_DATE,
                        INVALID_ADDRESS, VALID_STUDENTS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedTutorial tutorial = new JsonAdaptedTutorial(VALID_TUTORIAL_ID, VALID_MODULE_CODE, VALID_DATE,
                null, VALID_STUDENTS);
