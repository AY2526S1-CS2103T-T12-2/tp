...
public class JsonAdaptedTutorialTest {
    ...
    private static final String VALID_TUTORIAL_ID = TUTORIAL_MA1521_B202.getTutorialId().toString();
    private static final String VALID_MODULE_CODE = TUTORIAL_MA1521_B202.getModuleCode().toString();
    private static final String VALID_DATE = TUTORIAL_MA1521_B202.getDate().toString();
    private static final List<JsonAdaptedStudent> VALID_STUDENTS = TUTORIAL_MA1521_B202.getStudents().stream()
            .map(JsonAdaptedStudent::new)
            .collect(Collectors.toList());

    @Test
    public void toModelType_validTutorialDetails_returnsTutorial() throws Exception {
        JsonAdaptedTutorial tutorial = new JsonAdaptedTutorial(TUTORIAL_MA1521_B202);
        assertEquals(TUTORIAL_MA1521_B202, tutorial.toModelType());
    }
