...
public class JsonSerializableTAbsTest {
    ...
    private static final Path TYPICAL_PERSONS_FILE = TEST_DATA_FOLDER.resolve("typicalTutorialsAddressBook.json");
    private static final Path INVALID_PERSON_FILE = TEST_DATA_FOLDER.resolve("invalidTutorialAddressBook.json");
    private static final Path DUPLICATE_PERSON_FILE = TEST_DATA_FOLDER.resolve("duplicateTutorialAddressBook.json");
    ...
    public void toModelType_typicalTutorialsFile_success() throws Exception {
        ...
        TAbs typicalTutorialsTAbs = TypicalTutorials.getTypicalAddressBook();
