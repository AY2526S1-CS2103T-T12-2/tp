...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Tutorial expectedTutorial = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Tutorial expectedTutorialMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Tutorial expectedTutorial = new PersonBuilder(AMY).withTags().build();
