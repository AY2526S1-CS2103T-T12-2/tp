...
public class CommandTestUtil {
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in moduleCodes
    ...
    static {
        DESC_AMY = new EditTutorialDescriptorBuilder().withName(VALID_NAME_AMY)
                .withModuleCode(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditTutorialDescriptorBuilder().withName(VALID_NAME_BOB)
                .withModuleCode(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
