...
public class CopyTutorialCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (sourceTutorial == null) {
            throw new CommandException(String.format(MESSAGE_TUTORIAL_NOT_FOUND, sourceTutorialId.tutorialId));
        }
        ...
        if (model.hasTutorial(tempTutorial)) {
            throw new CommandException(String.format(MESSAGE_DUPLICATE_TUTORIAL, newTutorialId.tutorialId));
        }
        ...
        return new CommandResult(String.format(MESSAGE_SUCCESS,
                newTutorialId.tutorialId,
                sourceTutorial.getModuleCode().value,
                sourceTutorialId.tutorialId));
    }
