...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_CLASS_ID, PREFIX_ADDRESS, PREFIX_MODULE_CODE, PREFIX_DATE)
        ...
        TutorialId tutorialId = ParserUtil.parseName(argMultimap.getValue(PREFIX_CLASS_ID).get());
